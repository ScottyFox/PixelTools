    ...
    Properties
    {
        ...
        SubShader
        {
            ...
            Pass
            {
                ...
                float4 Unity_Blend_Darken_float4(float4 Base, float4 Blend, float Opacity)
                {
                    float4 output = min(Blend, Base);
                ...
                return Unity_Blend_Darken_float4(base, blend, mask);
                }
                ENDCG
            }
        }
