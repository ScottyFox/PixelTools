    ...
    Properties
    {
        ...
        SubShader
        {
            ...
            Pass
            {
                ...
                float4 Unity_Blend_Divide_float4(float4 Base, float4 Blend, float Opacity)
                {
                    float4 output = Base / (Blend + 0.000000000001);
                ...
                return Unity_Blend_Divide_float4(base, blend, mask);
                }
                ENDCG
            }
        }
