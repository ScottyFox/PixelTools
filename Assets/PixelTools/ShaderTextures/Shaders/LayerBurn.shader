    ...
    Properties
    {
        ...
        SubShader
        {
            ...
            Pass
            {
                ...
                float4 Unity_Blend_Burn_float4(float4 Base, float4 Blend, float Opacity)
                {
                    float4 output = 1.0 - (1.0 - Blend) / (Base + 0.000000000001);
                ...
                return Unity_Blend_Burn_float4(base, blend, mask);
                }
                ENDCG
            }
        }
