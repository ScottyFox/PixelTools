    ...
    Properties
    {
        ...
        SubShader
        {
            ...
            Pass
            {
                ...
                float4 Unity_Blend_Screen_float4(float4 Base, float4 Blend, float Opacity)
                {
                    float4 output = 1.0 - (1.0 - Blend) * (1.0 - Base);
                ...
                return Unity_Blend_Screen_float4(base, blend, mask);
                }
                ENDCG
            }
        }
