    ...
    Properties
    {
        ...
        SubShader
        {
            ...
            Pass
            {
                ...
                float4 Unity_Blend_LinearDodge_float4(float4 Base, float4 Blend, float Opacity)
                {
                    float4 output = Base + Blend;
                ...
                return Unity_Blend_LinearDodge_float4(base, blend, mask);
                }
                ENDCG
            }
        }
