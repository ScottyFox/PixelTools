    ...
    Properties
    {
        ...
        SubShader
        {
            ...
            Pass
            {
                ...
                float4 Unity_Blend_Negation_float4(float4 Base, float4 Blend, float Opacity)
                {
                    float4 output = 1.0 - abs(1.0 - Blend - Base);
                ...
                return Unity_Blend_Negation_float4(base, blend, mask);
                }
                ENDCG
            }
        }
