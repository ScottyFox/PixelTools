    ...
    Properties
    {
        ...
        SubShader
        {
            ...
            Pass
            {
                ...
                float4 Unity_Blend_LinearBurn_float4(float4 Base, float4 Blend, float Opacity)
                {
                    float4 output = Base + Blend - 1.0;
                ...
                return Unity_Blend_LinearBurn_float4(base, blend, mask);
                }
                ENDCG
            }
        }
