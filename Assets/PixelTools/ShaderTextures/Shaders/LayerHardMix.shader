    ...
    Properties
    {
        ...
        SubShader
        {
            ...
            Pass
            {
                ...
                float4 Unity_Blend_HardMix_float4(float4 Base, float4 Blend, float Opacity)
                {
                    float4 output = step(1 - Base, Blend);
                ...
                return Unity_Blend_HardMix_float4(base, blend, mask);
                }
                ENDCG
            }
        }
