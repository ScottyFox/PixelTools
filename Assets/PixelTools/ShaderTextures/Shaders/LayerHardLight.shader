    ...
    Properties
    {
        ...
        SubShader
        {
            ...
            Pass
            {
                ...
                float4 Unity_Blend_HardLight_float4(float4 Base, float4 Blend, float Opacity)
                {
                ...
                return Unity_Blend_HardLight_float4(base, blend, mask);
                }
                ENDCG
            }
        }
